...
let cars = [
  ...
  },
  {
    ...
    },
    {
        ...
        isBox:true,
        price:2000,
        photo:'https://krot.info/uploads/posts/2021-10/1634347714_58-krot-mobi-p-mersedes-gelik-mashini-krasivo-foto-58.jpg'
    },
...
cars.filter(item => {
    let key = "mark || color || engine || year || hasHatch || isBox ||price || img"
